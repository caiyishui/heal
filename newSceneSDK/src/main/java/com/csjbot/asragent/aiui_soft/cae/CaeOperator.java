...
public class CaeOperator {
    ...
    // 设备鉴权唯一标识
    private static final String DEFAULT_AUTH_SN = "614184de-f61d-4a05-93b3-85d052fc4b10";
    public static String AUTH_SN = TextUtils.isEmpty(ConfInfoUtil.getSN()) ? DEFAULT_AUTH_SN : ConfInfoUtil.getSN();

    private static boolean outPutVadAudio = true;
    ...
    private static String mVadAudioDir = "/sdcard/vtn/cae/caeVadAudio/";    // 降噪后音频保存路径
