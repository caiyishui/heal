...
public class RecOperator {
     ...
     * pcm 声卡号
     */
    private final static int mPcmCard = USBCardFiner.fetchCards(-1, name -> name.contains("AIUI"));
    /**
     * pcm 声卡设备号
     */
...
//    private final static int mPcmBufferSize = 8192;
    ...
    public void initRec(Context context, RecordListener mRecordListener) {
        CosLogger.error("AIUI Device {}  find ", ("/dev/snd/pcmC" + mPcmCard + "D" + mPcmDevice + "c"));
